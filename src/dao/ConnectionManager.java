...
public class ConnectionManager {
    ...
    // URL・ユーザ名・パスワードの設定
    private final static String URL = "jdbc:mysql://localhost:3306/webdb?characterEncoding=UTF-8&serverTimezone=JST";
    private final static String USER = "root";
    private final static String PASSWORD = "mysqluehara";
    // コネクションオブジェクト
